 ...
 */
export const getPlaylists = async (): Promise<IPlaylistDto[]> => {
  const {
    data: { playlists },
 ...
 */
export const getPlaylist = async (id: string): Promise<IPlaylistDto> => {
 ...
 */
export const createPlaylist = async (name: string): Promise<IPlaylistDto> => {
 ...
 */
export const addTrackToPlaylist = async (id: string, track: Track) => {
 ...
 */
export const addTracksToPlaylistByUrls = async (
  id: string,
  songs: SongInput[],
) => {
  const { data } = await graphQLClientPlaylists.mutate<
 ...
 * @param track Mobx cached Track
 */
export const removeTrackFromPlaylist = async (id: string, track: Track) => {
...
export const authenticate = async (
  ...
  const { data, errors } = await graphQLClientAuth.mutate<
    Token,
    CreateTokenInput
  >({
 ...
 */
export const getUserdata = async (): Promise<IUserInfoDto> => {
  const {
    data: { getSelf },
 ...
 */
export const searchTrack = async (term: string): Promise<ITrackDto[]> => {
  const {
    data: { songs },
 ...
 */
export const getTrackFromUrl = async (url: string): Promise<ITrackDto> => {
  const {
    data: { song },
 ...
 * @param id youtube id
 */
export const getRelatedTracks = async (id: string): Promise<ITrackDto[]> => {
  const {
    data: { radio },
